...
import "sigs.k8s.io/kubebuilder/testdata/project-v3-with-monitoring/monitoring/metrics/util"
...
// Add required functions for updating your metrics
// and call the functions from your operator controller code to update the metrics value.
